...
export const operationsModules: OperationsModule[] = [
  {
    title: "Checklists",
    description: "Opening, closing and routine tasks",
  ...
  {
    title: "Expenses",
    description: "Operating costs and payment records",
  ...
  },
  {
    ...
    description: "Equipment issues and repair progress",
    href: "/operations/maintenance-logs",
    icon: Settings2,
    color: "purple",
    allowedRoles: roles,
  },
  {
    title: "Shifts",
    description: "Staff shifts, floats and closing cash",
