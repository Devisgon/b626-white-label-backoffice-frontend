...
const payeeTypeInput = z
  .union([
    z.literal(""),
    z.enum(["vendor", "supplier", "individual", "utility", "other"]),
  ])
...
const optionalUuid = z
  .union([
    z.literal(""),
    z.string().uuid("Please select a valid bank account."),
  ])
  .optional();
...
export type PayeeFormInput = z.input<typeof payeeSchema>;

export type PayeeFormValues = z.output<typeof payeeSchema>;
