...
export const lotteryGameSchema = z.object({
  ...
  game_number: z
    ...
    .max(
      50,
      "Game number cannot exceed 50 characters.",
    ),
  ...
  tickets_per_pack: z
    ...
    .refine(
      ...
      {
        message:
          "Tickets per pack must be a whole number greater than zero.",
      },
    ),
...
export type LotteryGameFormValues =
  z.infer<typeof lotteryGameSchema>;