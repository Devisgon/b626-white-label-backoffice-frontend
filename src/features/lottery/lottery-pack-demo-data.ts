import type { LotteryPack } from "@/features/lottery/types";
...
export const demoLotteryPacks: LotteryPack[] = [
  {
    ...
    start_ticket_no: 1,
    end_ticket_no: 100,
    activated_at: "2026-08-25T09:00:00.000Z",
  ...
  },
  {
    ...
    start_ticket_no: 101,
    end_ticket_no: 140,
    activated_at: "2026-08-23T11:00:00.000Z",
    location_id: "d4f2a3b1-4321-4c5d-8e7f-1a2b3c4d5e6f",
    status: "Completed",
...
export function findDemoLotteryPack(id: number) {
  return demoLotteryPacks.find((pack) => pack.id === id);
}
