...
export type PosConnectionPayload = Pick<
  PosConnection,
  "siteName" | "serviceId" | "externalSiteId"
> &
  Partial<
    Pick<
      PosConnection,
...
export type PosMappingPayload = Omit<
  PosMapping,
  | "id"
  | "status"
  | "createdAt"
...
export interface PosOutboundBatch {
  id: string;
...
export interface PosInboundBatch {
  id: string;
